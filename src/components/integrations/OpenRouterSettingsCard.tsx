...
import { openrouter } from "../../integrations/openrouter-firecrawl";
...
export function OpenRouterSettingsCard() {
  ...
  const refresh = useCallback(async () => {
    ...
    setError("");
    try {
      setStatus(await openrouter.status());
    } catch (e) {
      setError(String(e));
    } finally {
      setLoading(false);
  ...
  return (
    <IntegrationCard
      name="OpenRouter"
      category="AI MODELS"
      description="Required for agent responses and profile extraction."
